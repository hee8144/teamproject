...
> **"주사위로 떠나는 우리 문화유산 여행"**  
> 공공데이터 API와 실시간 통신 기술을 활용한 한국 전통 테마의 교육용 보드게임 프로젝트입니다.
...
| 이름 | 역할 | 담당 업무 | 연락처 |
| :---: | :---: | :--- | :---: |
| [**본인 성함**](https://github.com/깃허브아이디) | FE / Logic | 3종 소셜 로그인 연동, 3D 찬스카드 연출 및 퀴즈 엔진 개발 | ✉️ email@example.com |
| [**팀원 2**](https://github.com/깃허브아이디) | FE / BE | 실시간 소켓 서버 구축 및 데이터 동기화, 방 관리 시스템 | ✉️ email@example.com |
| [**팀원 3**](https://github.com/깃허브아이디) | FE / Data | 문화재청 공공데이터 API 연동 및 파싱, 게임 규칙 엔진 개발 | ✉️ email@example.com |
| [**팀원 4**](https://github.com/깃허브아이디) | UI / UX | 전통 테마 디자인 시스템 구축, 애니메이션 및 컴포넌트 고도화 | ✉️ email@example.com |

---

## 🖼️ 주요 화면 미리보기 (Screenshots)

> **안내**: 아래는 프로젝트의 주요 UI/UX 포인트입니다. 가이드라인에 따라 스크린샷을 촬영하여 `assets/screenshots/` 경로에 저장해 주세요.
